...
| 2026-06-26 | scope-change | Investigation pivot: la domanda centrale non è più "perché Google non indicizza?" ma "Google ha costruito la propria crawl queue utilizzando una fotografia incompleta del sito durante il periodo di sitemap stale?". Motivazione: F-009 dimostra che Googlebot ha letto le sitemap stale; F-010 mostra assenza di crawl spontaneo per sessione 21-06-2026 nei log disponibili; H-004 (lastmod errato) falsificata da F-008. La nuova formulazione è più precisa rispetto all'evidenza raccolta e non assume causalità non dimostrata. Registrata come Q-001a. | Project owner | Adopted |
| 2026-06-26 | decision | Approvato design esperimento controllato T-002: prima sessione post-patch monitorata con timeline T0→T7 (pubblicazione → flush → sitemap PASS → primo GET Googlebot sitemap → landing → prodotto → indicizzazione GSC). Obiettivo: confronto diretto PRE PATCH (sessione 21-06-2026, baseline F-010) vs POST PATCH. Eliminata la variabile "sitemap stale" (F-011). Limitazione documentata: singolo datapoint, non sufficiente per conclusioni generali. | Project owner | Adopted |
